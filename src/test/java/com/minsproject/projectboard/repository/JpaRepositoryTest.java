...
import com.minsproject.projectboard.config.JpaConfig;
...
@Import(JpaConfig.class) //import를 추가하지 않으면 JpaAuditing이 정상적으로 추가되지 않는다.
@DataJpaTest
class JpaRepositoryTest {
    ...
    void givenTestData_whenDeleting_thenWorksFine() {
        //given
        Article article = articleRepository.findById(49L).orElseThrow();
